...
final class AppColor {
  ...
  static const Color gryffindor = Color(0xFF9B1B30);
  static const Color hufflepuff = Color(0xFFB7A63A);
  static const Color ravenclaw = Color(0xFF1F4E79);
  static const Color slytherin = Color(0xFF2A4731);
}
